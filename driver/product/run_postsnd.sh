#!/bin/ksh -l
#PBS -o /scratch4/NCEPDEV/meso/save/Guang.Ping.Lou/fv3gfs/driver/product/postsnd_00.out7
#PBS -e /scratch4/NCEPDEV/meso/save/Guang.Ping.Lou/fv3gfs/driver/product/postsnd_00.out7
#PBS -N postsnd
#PBS -A fv3-cpu
#PBS -l nodes=6:ppn=3
